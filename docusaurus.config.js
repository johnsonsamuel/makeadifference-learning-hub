...
const config = {
  ...
  tagline: 'Makeadifference learning hub',
  ...
  organizationName: 'Makeadifference', // Usually your GitHub org/user name.
  projectName: 'Makeadifference', // Usually your repo name.
